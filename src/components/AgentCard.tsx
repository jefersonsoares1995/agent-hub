  ...
  return (
    ...
    >
      <Link to={`/chat/${agent.id}`} className="block h-full">
        <div className="group relative h-full flex flex-col overflow-hidden rounded-xl border border-primary/20 bg-slate-950/50 p-6 pb-10 backdrop-blur-xl shadow-[0_0_15px_var(--primary-color,rgba(6,182,212,0.05))] transition-all duration-300 hover:scale-[1.02] hover:border-primary/50 hover:shadow-[0_0_30px_var(--primary-color,rgba(6,182,212,0.2))]">
          ...
          <div className="relative flex h-full flex-col">
            <div className="mb-4 flex items-center justify-between">
              <motion.div
                className="flex items-center justify-center rounded-lg bg-primary/10 p-3"
            ...
            <div className="mt-auto flex w-fit items-center gap-1 rounded-md px-3 py-1.5 text-sm font-medium text-primary opacity-0 transition-all duration-300 hover:bg-primary/10 group-hover:opacity-100">
